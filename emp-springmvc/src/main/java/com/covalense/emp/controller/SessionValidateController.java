...
public class SessionValidateController {
	...
	public String validateSession(HttpSession session, ModelMap modelMap, @PathVariable("url1") String url1,
			@PathVariable("url2") String url2, @Value("${invalidSessionMsg}") String msg) {
		if (session.isNew()) {
	...
	public String validateSessionPost(HttpSession session, ModelMap modelMap, @PathVariable("url1") String url1,
			@PathVariable("url2") String url2, @Value("${invalidSessionMsg}") String msg) {
