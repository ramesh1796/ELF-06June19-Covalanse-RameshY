...
import com.covalense.hibernate.manytoone.EmployeeAdreessPKBean;
import com.covalense.hibernate.manytoone.EmployeeEducationalInfoBean;
import com.covalense.hibernate.manytoone.EmployeeEducationalInfoPKBean;
import com.covalense.hibernate.manytoone.EmployeeExperienceInfoBean;
import com.covalense.hibernate.manytoone.EmployeeExperienceInfoPKBean;
...
public class App {
	public static void main(String[] args) {
		...
		/*
		 * EmployeeInfoBean empInf = new EmployeeInfoBean(); empInf.setId(320);
		 * empInf.setName("Vaishali"); empInf.setAge(28); empInf.setGender("Female");
		 * empInf.setSalary(19330); empInf.setPhone(80099075501L);
		 * empInf.setJoiningDate(new Date(2110 - 10 - 20));
		 * empInf.setAccountNumber(255225854); empInf.setEmail("nllest@gmail.com");
		 * empInf.setDesigtnation("JEE"); empInf.setDob(new Date(1950 - 06 - 06));
		 * empInf.setDepartmentId(822); empInf.setManagerId(1866);
		 * empInf.setPassword("vaishali123");
		 * 
		 * EmployeeOtherInfoBean otherInfoBean = new EmployeeOtherInfoBean();
		 * otherInfoBean.setAdhaar(35364647); otherInfoBean.setPan("H685YJ8");
		 * otherInfoBean.setBloodGrp("B+"); otherInfoBean.setChallenged(false);
		 * otherInfoBean.setEmergencyContactName("Mahima");
		 * otherInfoBean.setMarried(true); otherInfoBean.setNationality("India");
		 * otherInfoBean.setMotherNm("Mina"); otherInfoBean.setFatherNm("Dhram");
		 ...
		 * adreessPKBean1.setAddressType("T"); adreessPKBean1.setInfoBean(empInf);
		 * 
		 * EmployeeAdreessPKBean adreessPKBean2 = new EmployeeAdreessPKBean();
		 * adreessPKBean2.setAddressType("P"); adreessPKBean2.setInfoBean(empInf);
		 * 
		 * EmployeeAddressInfoBean addressInfoBean1 = new EmployeeAddressInfoBean();
		 * addressInfoBean1.setAddressPKBean(adreessPKBean1);
		 * addressInfoBean1.setAddress1("ABC"); addressInfoBean1.setAddress2("BBBB");
		 * addressInfoBean1.setCity("Bangalore"); addressInfoBean1.setCountry("India");
		 * addressInfoBean1.setPincode(455676); addressInfoBean1.setState("Yaman");
		 * 
		 * EmployeeAddressInfoBean addressInfoBean2 = new EmployeeAddressInfoBean();
		 * addressInfoBean2.setAddressPKBean(adreessPKBean2);
		 * addressInfoBean2.setAddress1("XYZ"); addressInfoBean2.setAddress2("AAAA");
		 * addressInfoBean2.setCity("Banaras"); addressInfoBean2.setLandmark("Ganga");
		 * addressInfoBean2.setState("UP"); addressInfoBean2.setCountry("India");
		 * addressInfoBean2.setPincode(453553);
		 * 
		 * EmployeeEducationalInfoPKBean educationalInfoPKBean1 = new
		 * EmployeeEducationalInfoPKBean();
		 * educationalInfoPKBean1.setEducationalType("Regular");
		 * educationalInfoPKBean1.setInfoBean(empInf);
		 * 
		 * EmployeeEducationalInfoPKBean educationalInfoPKBean2 = new
		 * EmployeeEducationalInfoPKBean();
		 ...
		 * educationalInfoBean1.setPercentage(76.9); educationalInfoBean1.setYop(new
		 * Date(2010 - 06 - 02));
		 * 
		 ...
		 * educationalInfoBean2.setPercentage(76.9); educationalInfoBean2.setYop(new
		 * Date(2014 - 06 - 12));
		 * 
		 * EmployeeExperienceInfoPKBean experienceInfoPKBean1 = new
		 * EmployeeExperienceInfoPKBean();
		 * experienceInfoPKBean1.setCompanyName("ABCDF");
		 * experienceInfoPKBean1.setInfoBean(empInf);
		 * 
		 * EmployeeExperienceInfoPKBean experienceInfoPKBean2 = new
		 * EmployeeExperienceInfoPKBean();
		 ...
		 * hibernateImpl.createEmployee(empInf, otherInfoBean,
