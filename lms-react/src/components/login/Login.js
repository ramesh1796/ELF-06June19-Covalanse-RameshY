...
login(event) {
  ...
  Axios.post('http://localhost/login',null,
  
  {
     ...
     if(response.data.message === 'Success') {
          ...
          if(response.data.beans[0].userType === "librarian") {
              this.props.history.push('/HomePageLib')
        ...
        <div className="container" style={{backgroundColor: 'white'}}>
          <div className="row">
            <div className="col-md-4 login-sec">
              ...
              <div className="copy-text">Don't have an account?<Link href="#">Register Now/Signup</Link></div>
            </div>
