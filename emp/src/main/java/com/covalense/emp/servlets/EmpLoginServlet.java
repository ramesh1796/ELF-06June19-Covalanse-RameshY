...
public class EmpLoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(req.getCookies()==null) {
			...
			out.print("<h1><span style=\"color:Red; margin-left:10px;\">"+"Please Enabled Your cookie"+"</span>"+"</h1>");
		...
		if (empPass.equals(bean.getPassword())) {
			...
			out.print("<HTML>");
			out.print("<BODY><BR><BR>");
			out.print("<h1><span style=\"color:Red; margin-left:10px;\">"+"Password is not correct!!"+"</span>"+"</h1>");
			dispatcher= req.getRequestDispatcher("login.html");
			dispatcher.include(req, resp);
			out.print("</BODY>");
			out.print("</HTML>");
